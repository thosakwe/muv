...
class NumberLiteral extends Literal {
  ...
  @override
  List<String> get comments => number.comments;

  @override
  FileSpan get span => number.span;

  @override
  num get value => _value ??= parse(number.span.text);
...
class HexLiteral extends Literal {
  ...
  @override
  List<String> get comments => hex.comments;
  ...
  @override
  num get value => _value ??= parse(hex.span.text);
}
